...
setuptools.setup(
    ...
    version=version,
    author="Tirth Motka",
    author_email="tirthpmotka@gmail.com",
    maintainer="Tirth Motka",
    maintainer_email="tirthpmotka@gmail.com",
    description="Telegram bot for displaying cryptocurrencies price",
    long_description=load_long_description("README.md"),
    long_description_content_type="text/markdown",
    url="https://github.com/SuperStar0907/Crypto-Tracker-bot",
    download_url="https://github.com/SuperStar0907/Crypto-Tracker-bot/archive/v%s.tar.gz" % version,
    license="MIT",
